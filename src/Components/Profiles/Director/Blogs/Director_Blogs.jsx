                    ...
                    {filteredUsers?.length === 0 ? (
                        ...
                        <table className="table-auto w-full mt-4 text-sm text-center overflow-auto">
                            ...
                            <tbody className="text-xs text-center font-semibold">
                                {filteredUsers?.map((blog_item) => (
                                    <tr key={blog_item?.id}>
                                        <td className="border px-4 py-2">{`${blog_item.firstName} ${blog_item.lastName}`}</td>
                                        <td className="border px-4 py-2">
                                            {blog_item?.email}
                                        </td>

                                        <td className="border px-4 py-2">
                                            {blog_item?.Service?.Name}
                                        </td>
                                        ...
                                        <td className="border px-4 py-2">
                                            <Link
                                                to={`/Director/Blogs/${blog_item.id}`}
